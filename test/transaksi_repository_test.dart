...
void main() {
  ...
  test('insertTransaksi should insert multiple transactions without replacing existing ones', () async {
    ...
    expect(allTransactions.length, equals(2), reason: 'Should have 2 transactions');
