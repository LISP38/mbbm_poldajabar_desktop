...
/// Implementasi [LaporanRepository] menggunakan Drift + SQLite.
///
/// Setelah refaktorisasi:
/// - Hanya berisi query yang dibutuhkan untuk proses **generate laporan**
/// - Operasi stok opname dan penerimaan BBM dipindahkan ke [StokOpnameRepositoryImpl]
class LaporanRepositoryImpl implements LaporanRepository {
  ...
  // ── Penerimaan BBM (read-only untuk running balance laporan) ──────────────
  ...
  // ── Stok Opname (read-only untuk titik awal running balance) ─────────────
  ...
  // ── Stok Sistem dari kupon (fallback) ─────────────────────────────────────
