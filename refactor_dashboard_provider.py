...
file_path = r'C:\Users\ridho\OneDrive\Desktop\TUGAS AKHIR\MBBM_APP\MBBM_Desktop\lib\presentation\providers\dashboard_provider.dart'

with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

# Add drift import if not present
if 'import \'package:drift/drift.dart\';' not in content:
    content = content.replace('import \'dart:async\';', 'import \'dart:async\';\nimport \'package:drift/drift.dart\' hide Column;')

# Fix db access
content = content.replace('await (_kuponRepository as KuponRepositoryImpl).dbHelper.database', '(_kuponRepository as KuponRepositoryImpl).appDatabase')
